...
export const AIChatWidget: React.FC = () => {
  ...
  const generateAIResponse = (query: string): string => {
    ...
    if (q.includes('english') || q.includes('iiuc') || q.includes('degree') || q.includes('education') || q.includes('semester')) {
      return "Tanzirul is an undergraduate student pursuing BA (Honours) in English Language & Literature at IIUC (7th Semester). He also achieved GPA 4.93 in Alim (2021) and GPA 4.81 in Dakhil (2019) at Jameya Ahmadia Sunnia Kamil Madrasah.";
    }
